...
var client_id2 = '***REMOVED***'; // Your client id
var client_secret2 = '***REMOVED***'; // Your secret

// your application requests authorization
var authOptions2 = {
  url: 'https://accounts.spotify.com/api/token',
  headers: {
    'Authorization': 'Basic ' + (new Buffer(client_id2 + ':' + client_secret2).toString('base64'))
  },
  form: {
...
app.get('/PopularMusic', function(req, res) {
